...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\Azure.Function.Tools\functions", "$global:testroot\..\Azure.Function.Tools\internal\functions"),
	
	[string]
	$ModuleName = "Azure.Function.Tools",
...
$CommandPath = @(
    "$global:testroot\..\Azure.Function.Tools\functions"
    "$global:testroot\..\Azure.Function.Tools\internal\functions"
)
