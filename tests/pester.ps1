...
Remove-Module Azure.Function.Tools -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\Azure.Function.Tools\Azure.Function.Tools.psd1"
Import-Module "$PSScriptRoot\..\Azure.Function.Tools\Azure.Function.Tools.psm1" -Force
